...
- [O&O ShutUp 10++](https://www.oo-software.com/shutup10)
- [CTT WinUtil](https://github.com/ChrisTitusTech/winutil)
- [DISM++](https://github.com/Chuyu-Team/Dism-Multi-language)
- [CTT BypassNRO](https://github.com/ChrisTitusTech/bypassnro)

## Firewalls:
- [Port Master](https://safing.io) (recommended)
- [WFC (Windows Firewall Control by Malwarebytes)](https://forums.malwarebytes.com/topic/296798-malwarebytes-windows-firewall-control-wfc)
